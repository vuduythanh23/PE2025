...
import { getCategories, createCategory, updateCategory, deleteCategory } from "../../utils/api/categories";
...
const CategoryManagement = ({ onDataChange }) => {
  ...
  const validateForm = () => {
    ...
    const duplicateSlug = categories.find(cat => 
      cat.slug === formData.slug && (!editingCategory || cat._id !== editingCategory._id)
    );
    if (duplicateSlug) {
