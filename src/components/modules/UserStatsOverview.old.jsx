...
const UserStatsOverview = ({ stats }) => {
  ...
  return (
    <ClientOnly fallback={<div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
      {[...Array(5)].map((_, i) => (
        <div key={i} className="bg-gray-200 p-4 rounded-lg shadow-sm border animate-pulse">
