...
export function LoadingProvider({ children }) {
  ...
  }, [loadingTimer]);  const handleAsyncOperation = useCallback(async (operation, errorMessage = 'An error occurred') => {
    startLoading();
    let timer = null;
  ...
  return (
    <LoadingContext.Provider value={{ isLoading, handleAsyncOperation, startLoading, stopLoading }}>
      {children}
      {isLoading && <Loader />}
